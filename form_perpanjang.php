...
$sql = "SELECT * FROM pinjam_buku WHERE id_pinjam='$_GET[id]'";
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Perpanjang Transaksi</h6>
                                </div>
                                <div class="card-body">



                                    <form method="POST" action="perpanjang_aksi.php">
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                <label>Id Pinjam</label>
                                                <input type="text" name="id_pinjam" class="form-control" readonly value="<?php echo $row['id_pinjam']; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Nama</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="nama_buku" class="form-control" readonly value="<?php echo $row['nama_buku']; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Tanggal Pinjam</label>
                                                <input type="text" name="tanggal_pinjam" class="form-control" readonly value="<?php echo $row['tanggal_pinjam']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                <label>Jumlah</label>
                                                <input type="text" name="jumlah_buku" class="form-control" readonly value="<?php echo $row['jumlah_buku']; ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Tanggal Kembali</label>
                                                <input type="date" name="tanggal_kembali" class="form-control" value="<?php echo $row['tanggal_kembali']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
